...
describe('LandingPageService', () => {
  ...
  it('Debe llamar el metodo getSocialNetworks() y retornar las redes sociales', ()=>{
    ...
    const req = httpMock.expectOne('https://cinemax-ded91.firebaseio.com/RedesSociales.json')
  ...
  it('Debe llamar el metodo getMovies() y retornar las peliculas', ()=>{
    ...
    const req = httpMock.expectOne('https://cinemax-ded91.firebaseio.com/Peliculas.json')
